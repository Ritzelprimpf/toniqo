...
/**
 * Privacy Policy screen — static placeholder.
 *
 * WebView or full policy text will be wired once a public policy URL exists.
 */
@Composable
...
@Preview(name = "PrivacyPolicyScreen — Dark", showBackground = true, backgroundColor = 0xFF1A1F22)
@Composable
private fun PrivacyPolicyScreenPreviewDark() {
    ToniqoTheme(useDarkTheme = true) { PrivacyPolicyScreen() }
}

@Preview(name = "PrivacyPolicyScreen — Light", showBackground = true, backgroundColor = 0xFFF8F9FA)
@Composable
private fun PrivacyPolicyScreenPreviewLight() {
    ToniqoTheme(useDarkTheme = false) { PrivacyPolicyScreen() }
}
