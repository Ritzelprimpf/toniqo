...
/**
 * `callbackFlow`-based implementation of [AudioCaptureSource].
 *
 ...
 *
 * Promoted from `tuner/data/MicrophoneAudioSourceImpl` to `audio/` in Phase 7.2.
 *
 * @property permissionChecker Checked as the very first step inside the flow body.
 */
@Singleton
class AudioRecordCaptureSource @Inject constructor(
    ...
    private companion object {
        const val TAG = "AudioRecordCaptureSource"
