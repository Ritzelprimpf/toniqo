 ...
 *
 * Promoted from `common/util/PitchDetector` to `audio/` in Phase 7.2 — YIN pitch detection
 * is part of the shared audio pipeline (capture → pitch extraction), so it belongs alongside
 * [AudioCaptureSource] in the same module. Decision recorded in `DECISIONS.md`.
 */
