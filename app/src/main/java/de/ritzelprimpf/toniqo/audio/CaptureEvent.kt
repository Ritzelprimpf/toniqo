...
/**
 * Events emitted by [AudioCaptureSource].
 *
 * The first emission from an [AudioCaptureSource.samples] flow is always one of:
 ...
 *
 * Promoted from `tuner/data/CaptureEvent` to `audio/` in Phase 7.2.
 */
...
/** Identifies which Android audio source [AudioRecordCaptureSource] actually opened. */
